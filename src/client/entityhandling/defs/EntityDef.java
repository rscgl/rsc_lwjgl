 ...
 * parameters present in the game's XML files, so they cannot be changed unless
 * the corresponding XML files are changed as well.
 *
 * Similarly, any changes to the package or class name must be reflected in the
 * initialisation of the Resources class, where aliases are set up for the XML
 * parser.
 */
