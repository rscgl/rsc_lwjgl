...
public class ResourceLoader {
	...
	public static final String DATA_DIR = Main.ASSET_DIRECTORY + "data/";
	...
	public static Object loadGzipData(String filename) {
		try {
			// InputStream is = new GZIPInputStream(getResourceAsStream(DATA_DIR
			// + filename));
			InputStream is = new GZIPInputStream(new FileInputStream(new File(DATA_DIR + filename)));
